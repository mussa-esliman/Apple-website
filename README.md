...
<html>
	...
	<body col>
		...
		<!--  -->
		<div class="top-100">
			<!-- included  over all section -->
			<div class="container-fluid text-center">
				<!-- macbook pro section -->
				<section class="macbook">
					<div><p class="fs-6 m-0">16-inch model</p></div>
					<div class=""><h2 class="fw-bold fs-1 m-0">MacBook Pro</h2></div>
					<div><p class="fs-2">The best for the brightest.</p></div>
					<!-- <div class="lern_buy">
				...
				<!-- iphone11 pro nsection -->

				<section class="bg_images iphon11 iphon11_pro text-white p-5">
					<div><h2 class="fw-bold fs-1">iPhone 11 Pro</h2></div>
					<div>
						<p class="fs-4">Pro cameras. Pro display. Pro performance.</p>
					</div>
					<div>
						<p class="opacity-75">From $24.95/mo. or $599 with trade‑in.</p>
					</div>

					<div class="lern_buy">
						<ul class="list-unstyled d-flex justify-content-center gap-4">
							<li>
								<a href="https://www.apple.com/iphone/" class="text-decoration-none" target="_blank">Learn more</a>
							</li>
							<li>
								<a href="https://www.apple.com/shop/buy-iphone" class="text-decoration-none" target="_blank">Buy</a>
							</li>
						</ul>
					</div>
				</section>
				...
				<section class="bg_images iphon11 p-5">
					<div><h2 class="fw-bold fs-1">iPhone 11</h2></div>
					<div><p class="fs-4">Just the right amount of everything.</p></div>
					<div>
						<p class="opacity-75">From $16.62/mo. or $399 with trade‑in.</p>
					</div>

					<div class="lern_buy">
						<ul class="list-unstyled d-flex justify-content-center gap-4">
							<li>
								<a href="https://www.apple.com/iphone/" class="text-decoration-none">Learn more</a>
							</li>
							<li>
								<a href="https://www.apple.com/shop/buy-iphone" class="text-decoration-none">Buy</a>
							</li>
						</ul>
					</div>
		...
		<!-- over all section for six  -->
		<section class="container-fluid text-center px-3">
			<!-- watche and card section -->
			<section class="row gap-3 m-3">
				<!-- watche div  at left side-->
				<div class="bg_images watche col-md pt-5">
					<div><img src="./images/icons/watch-series5-logo.png" alt="" /></div>
					<div>
						<p class="mb-0 fs-4">With the new Always-On Retina display.</p>
						<p class="mb-0 fs-4">You’ve never seen a watch like this.</p>
					</div>
				...
				<!-- card div at the right  -->
				<div class="bg_images Cardair col-md">
					<div class="pt-5">
			...
			<!-- Tv and  Airpad section-->
			<section class="row gap-3">
				<!-- TV div at the left -->
				<div
					class="bg_images Tv col-md d-flex justify-content-between flex-column">
					<div class="pt-5">
					...
					<div class="WatchT pb-5">
						<a class="text-decoration-none" href="/">Watch the trailer</a>
					</div>
				</div>
				<!-- Airpad div at the right -->
				<div class="bg_images Airpad col-md text-white">
					<div class="fw-bold fs-1 mt-5"><p>AirPods Pro</p></div>
					<div class="fs-5"><p>Magic like you’ve never heard.</p></div>
					<div class="lern_buy">
						<ul class="list-unstyled d-flex justify-content-center gap-4">
							<li>
								<a href="/" class="text-decoration-none">Learn more</a>
			...
			<!-- mackbook pro and ipad section -->
			<section class="row gap-3 m-3">
				<!-- mackbook pro div at the left -->
				<div class="mackbook_pro col-md">
					<div><p class="fs-6">16-inch model</p></div>
					<div class=""><h2 class="fw-bold fs-1">MacBook Pro</h2></div>
					<div><p class="fs-2">The best for the brightest.</p></div>
					<!-- <div class="lern_buy">
						<ul class="list-unstyled d-flex justify-content-center gap-4">
							<li>
							...
							<li>
								<a href="/" class="text-decoration-none btn btn-outline-primary  rounded-pill">Buy</a>
							</li>
						</ul>
					</div> -->
					<div class="d-flex justify-content-center gap-4 mb-3">
				...
				<!-- ipad div at the right -->
				<div class="bg_images ipad col-md">
					<div class="pt-5">
						<img src="./images/icons/new-ipad-logo.png" alt="" />
					</div>
					<div class=""><p>Like a computer. Unlike any computer</p></div>
					<div class="lern_buy">
						<ul class="list-unstyled d-flex justify-content-center gap-4">
							<li>
								<a href="/" class="text-decoration-none">Learn more</a>
